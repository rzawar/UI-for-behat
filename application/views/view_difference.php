        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="row">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-4 col-xs-6"><a title="Image 1" href="#">  <img src="<?php echo 'http://localhost/unitTesting/application/img/'.$image ; ?>" class="img-responsive img-thumbnail" style="min-height:200px;height:200px;" alt="Responsive image"><br><?php echo $image; ?></a></div>
                    <?php } ?>
                </div>
            </div>
        </div>

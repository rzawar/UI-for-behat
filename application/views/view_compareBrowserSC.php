...
<html>
    ...
    <body>
        ...
        <h3><?php
                ...
                if($isEdit == "true"){
                    echo '<div id="isEdit" class="alert alert-danger" role="alert"> <strong>Base file Edited . Please change the screenshotfeaturetest file as well</strong></div>';
            ...
            ?></h3>
             ...
             <div id ="browsercomparison" class =" blockMe col-md-6">
                 <h3>Select the browser to run your tests</h3> 
